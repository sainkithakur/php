...
if(isset($_POST['submit']))
{
  ...
  $query = mysqli_query($conn,"insert into fb(firstname,surname,email,password,day,month,year,gender) values ('$a','$b','$c','$d','$day','$month','$year','$gen')");
  $insertid = $conn->insert_id;
if($query)
{
   session_start();
  $_SESSION['LOIGIfb'] = $insertid;
