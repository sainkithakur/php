...
$fbuserdata = mysqli_fetch_array(mysqli_query($conn,"select * from fb where id='$logifbid'"));
//var_dump($userdata);
?>
    ...
    <img src="image/sainki6.jpg" class="f1">
     <img src="image/sainki7.jpg" class="f1">
        ...
        <div class="box9" style="display: grid;">
          ...
          <a href="logout.php"><button type="btn" name="button" class="btnset2"><img src="img/tmaz0VO75BB.png" class="img-fluid"> log out</button></a>
        </div>
